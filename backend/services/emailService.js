...
class EmailService {
  ...
  // Send a general email with specified to, subject, html and optional plain text content
  ...
  // Send email for email verification with a unique token and personalized greeting
  ...
  // Send password reset email with token and personalized greeting
  ...
  // Send order confirmation email with order details and buyer's first name
  ...
  // Utility method to strip HTML tags from a string for plain text fallback
  stripHtml(html) {
